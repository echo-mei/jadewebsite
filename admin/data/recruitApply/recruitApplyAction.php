...
if($method=='listRecruitApply') {
    ...
    if($_POST['recruitFrom'] == "PC"){
        $newName=uploadFile('../../../file/img',$allowExt,512000,false);
    }else{
        $newName=uploadFile('../../../file/img',$allowExt,921600,false);
    }
...
//        computerLevel => $_POST['computerLevel'],//计算机等级
        ...
        practiceExperience => $_POST['practiceExperience'],//工作经历
        shixiExperience => $_POST['shixiExperience'],//实习经历
